...
public class EthTunnelInterface extends NetInterface {
	...
	nemo.it.unipr.netsec.rawsocket.udp.DatagramSocket datagram_socket_raw=null;
	...
	public EthTunnelInterface(Address addr, int local_port, SocketAddress remote_soaddr) throws SocketException {
		...
		try {
			...
			if (local_port>0) datagram_socket_raw=new nemo.it.unipr.netsec.rawsocket.udp.DatagramSocket(local_port);
			else datagram_socket_raw=new nemo.it.unipr.netsec.rawsocket.udp.DatagramSocket();
