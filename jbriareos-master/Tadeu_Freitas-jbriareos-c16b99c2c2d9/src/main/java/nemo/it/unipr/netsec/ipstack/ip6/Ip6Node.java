...
package nemo.it.unipr.netsec.ipstack.ip6;


import nemo.it.unipr.netsec.ipstack.icmp6.Icmp6Message;
import nemo.it.unipr.netsec.ipstack.icmp6.SolicitedNodeMulticastAddress;
import nemo.it.unipr.netsec.ipstack.icmp6.message.Icmp6DestinationUnreachableMessage;
import nemo.it.unipr.netsec.ipstack.icmp6.message.Icmp6EchoReplyMessage;
import nemo.it.unipr.netsec.ipstack.icmp6.message.Icmp6EchoRequestMessage;
import nemo.it.unipr.netsec.ipstack.icmp6.message.Icmp6TimeExceededMessage;
import nemo.it.unipr.netsec.ipstack.ip4.IpAddress;
import nemo.it.unipr.netsec.ipstack.ip4.IpPrefix;
import nemo.it.unipr.netsec.ipstack.ip6.exthdr.ExtensionHeader;
import nemo.it.unipr.netsec.ipstack.ip6.exthdr.RoutingHeader;
import nemo.it.unipr.netsec.ipstack.ip6.exthdr.SegmentRoutingHeader;
...
import nemo.it.unipr.netsec.ipstack.routing.RoutingTable;
 ...
 * Use method {@link #getRoutingTable()} and method {@link nemo.it.unipr.netsec.ipstack.routing.RoutingTable#add(Route)} to add more routing entries.
 * <p>
