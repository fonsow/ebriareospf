package nemo.it.unipr.netsec.nemo.routing;


import nemo.it.unipr.netsec.nemo.routing.graph.Edge;
import nemo.it.unipr.netsec.nemo.routing.graph.Graph;
import nemo.it.unipr.netsec.nemo.routing.graph.Node;
import nemo.it.unipr.netsec.nemo.routing.graph.Path;
 ...
 *  <p>
 *  It provides methods for converting {@link nemo.it.unipr.netsec.nemo.routing.graph.Graph} objects to node indexes and vice-versa.
 */
class SimpleGraph {
	 ...
	 * It converts a {@link nemo.it.unipr.netsec.nemo.routing.graph.Graph} to a adjacency matrix of a simple-graph.
	 * @param g the graph */
