...
import nemo.it.unipr.netsec.ipstack.util.IpAddressUtils;
import nemo.it.unipr.netsec.nemo.ip.Ip4Host;
import nemo.it.unipr.netsec.nemo.ip.Ip6Host;
import nemo.it.unipr.netsec.nemo.ip.IpLink;
import nemo.it.unipr.netsec.nemo.link.DataLink;
import nemo.it.unipr.netsec.nemo.link.Network;
import nemo.it.unipr.netsec.nemo.link.NetworkBuilder;
import nemo.it.unipr.netsec.nemo.link.PacketGenerator;
...
public class RoutingTest {
	 ...
	 * @param print_routing_table prints routing table of the first router */
